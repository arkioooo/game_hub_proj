...
WIDTH = 800
HEIGHT = 500
FPS = 24                                                 #controls how often the gameDisplay should refresh. In our case, it will refresh every 1/12th second
pygame.init()
...
while game_running :
    ...
    for key, value in data.items():
        if value['throw']:
            ...
            value['speed_y'] += (0.5 * value['t'])    #increasing y-corrdinate
